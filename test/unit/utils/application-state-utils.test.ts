...
describe('application-state-utils', () => {
  ...
  it('when application status is ended should get correct Do this next section.', () => {
    ...
    expect(result).to.deep.include(
      {
        ...
        'deadline': 'TBC',
        descriptionParagraphs: [
          'Review your <a href=\"{{ paths.common.detailsViewers.appealDetails }}\">Notice of Ended Appeal</a>. This includes details of who ended the appeal and why.',
