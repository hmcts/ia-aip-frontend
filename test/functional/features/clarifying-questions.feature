...
Feature: Clarifying questions
  ...
  @disabled Scenario: Answering Clarifying questions
  ...
  @disabled Scenario: Answering Clarifying questions save for later
    When I click "Answer question 1" link
    Then I see "Question 1" in title
  ...
  @disabled Scenario: Ask for more time while answering Clarifying questions
    When I click "Answer question 1" link
