...
echo "IA_CASE_PAYMENTS_API_URL=http://ia-case-payments-api-aat.service.core-compute-aat.internal" >> "$OUTPUT_FILE"
echo "PCQ_RETURN_URL=immigration-appeal.aat.platform.hmcts.net/about-appeal" >> "$OUTPUT_FILE"
