...
function getOtherAppealApplication(req: Request<Params>, res: Response, next: NextFunction) {
  const config = {
    validationErrors: {
...
function postOtherAppealApplication(req: Request<Params>, res: Response, next: NextFunction) {
