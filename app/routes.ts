...
import { setupHearingApplicationControllers } from './controllers/make-application/hearing-requests/setup-hearing-application-controllers';
...
const hearingApplicationControllers = setupHearingApplicationControllers(middleware, updateAppealService, documentManagementService);
...
router.use(hearingApplicationControllers);
