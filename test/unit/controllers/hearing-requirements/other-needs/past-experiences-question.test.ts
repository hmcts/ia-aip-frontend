...
describe('Hearing Requirements - Other Needs Section: Past Experiences Question controller', () => {
  ...
  describe('setupHearingPastExperiencesQuestionController', () => {
    it('should setup routes', () => {
      ...
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.otherNeedsPastExperiences)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.otherNeedsPastExperiences)).to.equal(true);
    });
  });
