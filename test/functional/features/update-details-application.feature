@updateDetailsFeature
Feature: Make Application to change some of my details
  In order to change some of my details on an appeal
  As a citizen
  I want to be able to make an application to change some of my details

  @disabled Scenario: Make an Application to withdraw an appeal 1
