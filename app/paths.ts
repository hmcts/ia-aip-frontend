const paths = {
  appealStarted: {
    ...
    uploadLocalAuthorityLetter: '/upload-local-authority-letter',
    uploadLocalAuthorityLetterUpload: '/upload-local-authority-letter/upload',
    uploadLocalAuthorityLetterDelete: '/upload-local-authority-letter/delete',
