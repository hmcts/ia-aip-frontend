...
const { reasonForAppeal } = require('../pages/case-building/reason-for-appeal/reason-for-appeal');
const { reasonForAppealCYA } = require('../pages/case-building/reason-for-appeal/reason-for-appeal-cya');
const { reasonForAppealConfirmation } = require('../pages/case-building/reason-for-appeal/reason-for-appeal-confirmation');
