...
describe('Hearing Requirements - Single sex all male Reason controller', () => {
  ...
  describe('setupSingleSexHearingAllMaleReasonController', () => {
    it('should setup the routes', () => {
      ...
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.otherNeedsAllMaleHearing)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.otherNeedsAllMaleHearing)).to.equal(true);
    });
  });
