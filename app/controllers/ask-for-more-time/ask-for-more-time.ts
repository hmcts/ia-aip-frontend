...
import { formatTextForCYA, getRedirectPage, handleNlrStatementValidation, hasActiveNlr } from '../../utils/utils';
...
function setupAskForMoreTimeController(middleware, deps?: any): Router {
  ...
  router.post(paths.common.askForMoreTimeSupportingEvidenceUpload, middleware, postUploadEvidence(deps.documentManagementService, deps.updateAppealService));
