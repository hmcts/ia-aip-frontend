...
const usersToCaseData: Record<string, any[]> = {
  ...
  '60': [mockData.appealSubmittedCaseData],
  ...
  '65': [mockData.startAppealUpToHasSponsorOrNlr],
  '66': [mockData.startAppealUpToHasSponsorOrNlr],
  '67': [mockData.startAppealUpToHasSponsorOrNlr],
