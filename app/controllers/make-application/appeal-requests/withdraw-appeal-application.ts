...
function getWithdrawAppealApplication(req: Request<Params>, res: Response, next: NextFunction) {
  const config = {
    validationErrors: {
...
function postWithdrawAppealApplication(req: Request<Params>, res: Response, next: NextFunction) {
