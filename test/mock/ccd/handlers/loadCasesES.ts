...
const usersToCaseData: Record<string, any> = {
  ...
  '33': dataToES(mockData.outOfTimeDecisionGranted2),
  '34': dataToES(mockData.outOfTimeDecisionRejected2),
  '35': dataToES(mockData.outOfTimeDecisionInTime2),
  ...
  '56': dataToES(mockData.appealSubmittedWithNlrDetails2),
  '57': dataToES(mockData.appealSubmittedWithNlrId),
  '58': dataToES(mockData.appealSubmittedWithNlrId2),
  '59': dataToES(mockData.appealSubmittedWithNlrIdWithSponsor),
  '60': dataToES(mockData.appealSubmittedWithNoNlrDetails),
