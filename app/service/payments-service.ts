...
export default class PaymentService {
  ...
  async createCardPayment(req: Request, fee) {
    ...
    req.app.locals.logger.trace(`Creating Card Payment with fee ${JSON.stringify(fee)} for appeal ref ${JSON.stringify(req.session.appeal.ccdCaseId)}`, 'Payments Service');
