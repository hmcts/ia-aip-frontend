...
Feature: Make Application to adjourn hearing
  ...
  @disabled Scenario: Make an Application to adjourn hearing
    ...
    When I select I want to ask for the hearing to be later and click continue
    Then I see "/ask-change-date" in current url
