...
import { setupHearingApplicationTypeController } from './controllers/make-application/hearing-requests/hearing-application-type';
...
const hearingApplicationTypeController = setupHearingApplicationTypeController(middleware);
...
router.use(hearingApplicationTypeController);
