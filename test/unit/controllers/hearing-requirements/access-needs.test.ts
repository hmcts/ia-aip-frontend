...
describe('Hearing requirements access needs controller', () => {
  ...
  describe('setupHearingAccessNeedsController', () => {
    it('should setup the routes', () => {
      ...
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.accessNeeds)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingInterpreter)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingInterpreterTypes)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingInterpreterSpokenLanguageSelection)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingInterpreterSignLanguageSelection)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingLanguageDetails)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingLanguageDetailsRemove)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingStepFreeAccess)).to.equal(true);
      expect(routerGetStub.calledWith(paths.submitHearingRequirements.hearingLoop)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingInterpreter)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingInterpreterTypes)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingInterpreterSpokenLanguageSelection)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingInterpreterSignLanguageSelection)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingLanguageDetails)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingLanguageDetailsAdd)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingStepFreeAccess)).to.equal(true);
      expect(routerPostStub.calledWith(paths.submitHearingRequirements.hearingLoop)).to.equal(true);
    });
  });
  ...
  describe('InterpreterSpokenLanguagePage', () => {
    ...
    it('postInterpreterSpokenLanguagePage should redirect to sign language selection page if witness need sign language support', async () => {
      ...
      expect(redirectStub.calledWith(paths.submitHearingRequirements.hearingInterpreterSignLanguageSelection + '?selectedWitnesses=' + req.body.selectedWitnessesList)).to.equal(true);
    ...
    it('postInterpreterSpokenLanguagePage should redirect to hearing step free access page if no more interpreter service is required', async () => {
      ...
      expect(redirectStub.calledWith(paths.submitHearingRequirements.hearingStepFreeAccess)).to.equal(true);
    ...
    it('postInterpreterSpokenLanguagePage should redirect to appellant sign language selection page if there is no parameter of selectedWitnessesList', async () => {
      ...
      expect(redirectStub.calledWith(paths.submitHearingRequirements.hearingInterpreterSignLanguageSelection)).to.equal(true);
    ...
    it('postInterpreterSpokenLanguagePage should redirect to witness interpreter type page if there is only one witness', async () => {
      ...
      expect(redirectStub.calledWith(paths.submitHearingRequirements.hearingInterpreterTypes + '?selectedWitnesses=0')).to.equal(true);
  ...
  describe('InterpreterSignLanguagePage', () => {
    ...
    it('postInterpreterSignLanguagePage should redirect to interpreter type selection page for next witness', async () => {
      ...
      expect(redirectStub.calledWith(paths.submitHearingRequirements.hearingInterpreterTypes + '?selectedWitnesses=2')).to.equal(true);
  ...
  describe('Remove additional language', () => {
    ...
    it('should remove language from session and redirect', async () => {
      ...
      expect(redirectStub.calledWith(paths.submitHearingRequirements.hearingLanguageDetails)).to.equal(true);
    });
