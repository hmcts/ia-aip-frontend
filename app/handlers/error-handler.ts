 ...
 */
function pageNotFoundHandler(req: Request<Params>, res: Response, next: NextFunction) {
 ...
 */
function serverErrorHandler(err: any, req: Request<Params>, res: Response, next: NextFunction) {
