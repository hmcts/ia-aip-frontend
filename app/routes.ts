...
import { setupAccessNeedsController } from './controllers/hearing-requirements/access-needs';
...
const submitHearingRequirementsAccessNeedsController = setupAccessNeedsController([hearingRequirementsMiddleware], updateAppealService);
