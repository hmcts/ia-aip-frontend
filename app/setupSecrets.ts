...
const setupSecrets = () => {
  ...
  setSecret('secrets.ia.ia-managed-redis-connection-string', 'session.redis.url');
  ...
  setSecret('secrets.ia.test-judge-x-password', 'testAccounts.testJudgePassword');
  setSecret('secrets.ia.test-law-firm-share-case-a-password', 'testAccounts.testLawFirmAPassword');
