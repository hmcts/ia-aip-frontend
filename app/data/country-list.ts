export const countryList = [
  ...
  { value: 'CG', name: 'Congolese (DRC)' },
  { value: 'CD', name: 'Congolese (Congo)' },
  { value: 'CK', name: 'Cook Islander' },
  { value: 'CR', name: 'Costa Rican' },
  { value: 'HR', name: 'Croatian' },
  { value: 'CU', name: 'Cuban' },
  { value: 'CE', name: 'Cymraes' },
  { value: 'CC', name: 'Cymro' },
