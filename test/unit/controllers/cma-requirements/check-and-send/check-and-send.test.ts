...
describe('CMA Requirements Check and Send controller', () => {
  ...
  describe('getCheckAndSendPage', () => {
      ...
      summarySections: [{
        ...
        summaryLists: [{
          ...
          summaryRows: [{ key: { text: 'Question' }, value: { html: 'Will you need an interpreter?' } }, {
            actions: {
              items: [{
                href: '/appointment-interpreter?edit',
                text: 'Change',
            ...
            actions: {
              items: [{
                href: '/appointment-add-language-details?edit',
                text: 'Change',
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-step-free-access?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-hearing-loop?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
        ...
        summaryLists: [{
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-multimedia-evidence?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
            ...
            actions: {
              items: [{
                href: '/appointment-multimedia-evidence-equipment?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
            ...
            actions: {
              items: [{
                href: '/appointment-multimedia-evidence-equipment-reasons?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-single-sex?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
            ...
            actions: {
              items: [{
                href: '/appointment-single-sex-type?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
            ...
            actions: {
              items: [{
                href: '/appointment-single-sex-type-male?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-private-reasons?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-physical-mental-health?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
            ...
            actions: {
              items: [{
                href: '/appointment-physical-mental-health-reasons?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-past-experiences?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
            ...
            actions: {
              items: [{
                href: '/appointment-past-experiences-reasons?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
          ...
          summaryRows: [{
            ...
            actions: {
              items: [{
                href: '/appointment-anything-else?edit',
                text: 'Change',
                visuallyHiddenText: 'Answer'
              }]
            },
    ...
    it('should render CYA template page with requirements', () => {
      getCheckAndSendPage(req as Request, res as Response, next);
      expectedArgs.hasNlr = false;
      expectRenderedCalledWithArgs(renderStub, 'templates/check-and-send.njk', expectedArgs);
    });

    it('should render CYA template page with requirements with NLR', () => {
      setActiveNlr(req);
      getCheckAndSendPage(req as Request, res as Response, next);
      expectedArgs.hasNlr = true;
      expectRenderedCalledWithArgs(renderStub, 'templates/check-and-send.njk', expectedArgs);
    });
