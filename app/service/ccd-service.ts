...
export const Events = {
  ...
  EDIT_CLARIFYING_QUESTION_ANSWERS: { id: 'editClarifyingQuestionAnswers', summary: 'Edit clarifying question answers', description: 'Edit clarifying question answers' },
