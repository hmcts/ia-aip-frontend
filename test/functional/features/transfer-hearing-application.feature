@transferHearingFeature
Feature: Make Application to transfer hearing
  In order to change the location of the hearing
  As a citizen
  ...
  Scenario: Make an Application to transfer hearing
    ...
    When I select I want to change the hearing location and click continue
    Then I see "/ask-change-location" in current url

    Then I fill textarea with "Where do you want the hearing to take place and why?"
