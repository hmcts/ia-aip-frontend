const paths = {
  appealStarted: {
    ...
    hasSponsorOrNlr: '/has-sponsor-or-non-legal-rep',
    sponsorName: '/sponsor-name',
    sponsorAddress: '/sponsor-address',
    sponsorContactDetails: '/sponsor-contact-preferences',
    sponsorAuthorisation: '/sponsor-authorisation',
    isSponsorSameAsNlr: '/is-same-person',
    nlrName: '/non-legal-rep-name',
    nlrAddress: '/non-legal-rep-address',
    nlrContactDetails: '/non-legal-rep-contact-details',
  ...
  nonLegalRep: {
    ...
    provideNlrName: '/add-non-legal-rep/provide-name',
