...
function getProvideSupportingEvidenceCheckAndSend(req: Request, res: Response, next: NextFunction) {
  return makeApplicationControllersHelper.getProvideSupportingEvidenceCheckAndSend(req, res, next, makeApplicationControllersHelper.getProvideSupportingEvidenceConfig(req));
}
