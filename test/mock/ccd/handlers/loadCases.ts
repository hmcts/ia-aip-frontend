...
const usersToCaseData: Record<string, any[]> = {
  ...
  '52': [mockData.startAppealUpToHasSponsorOrNlr],
  '53': [mockData.appealSubmittedWithNlrEmailWithoutSponsor],
  '54': [mockData.appealSubmittedWithNlrEmailWithSponsor],
  '55': [mockData.appealSubmittedWithNlrDetails],
  '56': [mockData.appealSubmittedWithNlrDetails2],
  '57': [mockData.appealSubmittedWithNlrId],
  '58': [mockData.appealSubmittedWithNlrId2],
  '59': [mockData.appealSubmittedWithNlrIdWithSponsor],
  '60': [mockData.appealSubmittedWithNoNlrDetails],
  '61': [mockData.appealSubmittedWithNlrIdWithSponsor2],
  '62': [mockData.appealSubmittedWithNlrId2],
  '63': [mockData.appealSubmittedWithNlrId3],
  '64': [mockData.appealSubmittedWithNlrId],
  '65': [mockData.startAppealUpToHasSponsorOrNlr2],
  '66': [mockData.startAppealUpToHasSponsorOrNlr3],
  '67': [mockData.startAppealUpToHasSponsorOrNlr4],
  '68': [mockData.submitHearingRequirementsAccessNeedsCompleted],
  '69': [mockData.submitHearingRequirementsAccessNeedsCompletedNlrAttending],
  '70': [mockData.submitHearingRequirementsAccessNeedsCompletedNoActiveNlr],
