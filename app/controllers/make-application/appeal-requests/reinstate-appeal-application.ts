...
function getReinstateAppealApplication(req: Request<Params>, res: Response, next: NextFunction) {
  const config = {
    validationErrors: {
...
function postReinstateAppealApplication(req: Request<Params>, res: Response, next: NextFunction) {
